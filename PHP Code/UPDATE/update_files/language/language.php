<?php
	  ...
	  $client_lang['15'] = "Envato username or purchase code is wrong!"; 

	  $client_lang['16'] = "Verified successfully!"; 

	  $client_lang['17'] = "Notification send successfully"; 
	  
      $client_lang['18'] = "Added successfully..."; 

      $client_lang['book_required']="Please select uploads .pdf and .epub";
?>