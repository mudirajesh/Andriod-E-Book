...
include("includes/header.php");
  ...
  { 
    ...
    $qry_songs="SELECT COUNT(*) as num FROM tbl_books WHERE `cat_id`='".$cat_id."'";
                ...
                <div class="block_wallpaper add_wall_category">           
                  <div class="wall_image_title">
                    ...
                    <?php if($row['show_on_home']!='0'){?>
                        <li>
                          <a href="javascript:void(0)" class="toggle_btn_a" data-id="<?php echo $row['cid'];?>" data-action="deactive" data-column="show_on_home" data-toggle="tooltip" data-tooltip="Show Home">
                              <i class="fa fa-home" style="color: green"></i>
                            </a>
                        </li>
                      <?php }else{?>
                        <li>
                          <a href="javascript:void(0)" class="toggle_btn_a" data-id="<?php echo $row['cid'];?>" data-action="active" data-column="show_on_home" data-toggle="tooltip" data-tooltip="Set On Home"><i class="fa fa-home"></i>
                            </a>
                        </li>
                      <?php }?>          
                      ...
                      <li>
                        <a href="" data-id="<?php echo $row['cid'];?>" data-toggle="tooltip" data-tooltip="Delete" class="btn_delete_a">
